...
<head>
  ...
  <title>warmglue: server error</title>
  <meta charset="utf-8">
  <meta name="description" content="warmglue is having an internal server error.">
...
<body>
  ...
  <div class="main-body">
    <div class="basic-info">
      <h1>server error</h1>
      <p class="big-text">Servers are being upgraded right now. If things still aren't working for you in the next few hours, reach out: support@warmglue.com</p>
    </div>
  </div>
