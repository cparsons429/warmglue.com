...
<head>
  ...
  <title>warmglue: access denied</title>
  <meta charset="utf-8">
  <meta name="description" content="You don't have permission to view that page.">
...
<body>
  ...
  <div class="main-body">
    <div class="basic-info">
      <h1>access denied</h1>
      <p class="big-text">You don't have permission to view that page. Let's take you back <a class="big-text-link" href="home">home</a>.</p>
    </div>
  </div>
