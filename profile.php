    ...
    <form name="set-profile" action="backend/update-profile.php" method="post">
      ...
      <?php
        ...
        if (isset($_SESSION['last_name_attempt'])) {
          echo sprint("<p class=\"form-text\">last name</p><input type=\"text\" name=\"last_name\" placeholder=\"Doe\" value=\"%s\"><img class=\"empty-x\"><br><br>", $_SESSION['last_name_attempt']);
        } else {
        ...
        if (isset($_SESSION['email_attempts'])) {
          // the user has input emails, but they were rejected
          echo sprintf("<p class=\"form-text e00\">email</p><input type=\"text\" class=\"e00\" name=\"email00\" placeholder=\"\" value=\"%s\"><img class=\"empty-x\"><br>", $_SESSION['email_attempts'][0]);
          echo sprintf("<p class=\"form-text e01\">email</p><input type=\"text\" class=\"e01\" name=\"email01\" placeholder=\"janedoe67@outlook.com\" value=\"%s\"><img class=\"x e01\" id=\"xe01\" onClick=\"delete_this(this.id)\"><br class=\"e01\">", $_SESSION['email_attempts'][1]);
          echo sprintf("<p class=\"form-text e02\">email</p><input type=\"text\" class=\"e02\" name=\"email02\" placeholder=\"doe@wustl.edu\" value=\"%s\"><img class=\"x e02\" id=\"xe02\" onClick=\"delete_this(this.id)\"><br class=\"e02\">", $_SESSION['email_attempts'][2]);
          echo sprintf("<p class=\"form-text e03\">email</p><input type=\"text\" class=\"e03\" name=\"email03\" placeholder=\"jane@amazon.com\" value=\"%s\"><img class=\"x e03\" id=\"xe03\" onClick=\"delete_this(this.id)\"><br class=\"e03\">", $emails[3]);

          // create form elements for each of the emails the user has input
          for($i = 4; $i < count($_SESSION['email_attempts']); $i++) {
            echo sprintf("<p class=\"form-text e%d%d\">email</p><input type=\"text\" class=\"e%d%d\" name=\"email%d%d\"  value=\"%s\"><img class=\"x e%d%d\" id=\"xe%d%d\" onClick=\"delete_this(this.id)\"><br class=\"e%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['email_attempts'][$i], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);
          }

          // create form elements for extra emails (30 total emails are created as a buffer)
          for($i = count($_SESSION['email_attempts']); $i < 30; $i++) {
          ...
          echo sprintf("<p class=\"form-text e01\">email</p><input type=\"text\" class=\"e01\" name=\"email01\" placeholder=\"janedoe67@outlook.com\" value=\"%s\"><img class=\"x e01\" id=\"xe01\" onClick=\"delete_this(this.id)\"><br class=\"e01\">", $emails[1]);
          echo sprintf("<p class=\"form-text e02\">email</p><input type=\"text\" class=\"e02\" name=\"email02\" placeholder=\"doe@wustl.edu\" value=\"%s\"><img class=\"x e02\" id=\"xe02\" onClick=\"delete_this(this.id)\"><br class=\"e02\">", $emails[2]);
          echo sprintf("<p class=\"form-text e03\">email</p><input type=\"text\" class=\"e03\" name=\"email03\" placeholder=\"jane@amazon.com\" value=\"%s\"><img class=\"x e03\" id=\"xe03\" onClick=\"delete_this(this.id)\"><br class=\"e03\">", $emails[3]);
        ...
        if (isset($_SESSION['occupation_attempts'])) {
          // the user has input occupations, but they were rejected

          // occupation00
          echo sprintf("<p class=\"form-text\">position</p><input type=\"text\" name=\"position00\" placeholder=\"B.A. Major in Math, Minor in Spanish\" value=\"%s\"><img class=\"empty-x\"><br>", $_SESSION['occupation_attempts'][0][0]);

          echo sprintf("<p class=\"form-text\">organization</p><input type=\"text\" name=\"organization00\" placeholder=\"Washington University in St. Louis\" value=\"%s\"><img class=\"empty-x\"><br>", $_SESSION['occupation_attempts'][0][1]);

          echo sprintf("<p class=\"form-text\">start</p><input type=\"text\" name=\"startdate00\" placeholder=\"mm/dd/yyyy\" value=\"%s\"><img class=\"empty-x\"><br>", $_SESSION['occupation_attempts'][0][2]);

          echo sprintf("<p class=\"form-text\">end</p><input type=\"text\" name=\"enddate00\" placeholder=\"mm/dd/yyyy (\"now\" if it's a current occupation)\" value=\"%s\"><img class=\"empty-x\"><br>", $_SESSION['occupation_attempts'][0][3]);

          echo sprintf("<p class=\"form-text\">projects</p><textarea name=\"projects00\" placeholder=\"Delta Sigma Pi business fraternity, Design-Build-Fly, Partners in East St. Louis\" value=\"%s\"></textarea><img class=\"empty-x\"><br><br><br><br><br><br><br><br><br>". $_SESSION['occupation_attempts'][0][4]);

          // occupation01
          echo sprintf("<p class=\"form-text o01\">position</p><input type=\"text\" class=\"o01\" name=\"position01\" placeholder=\"Software Engineering Intern\" value=\"%s\"><img class=\"x o01\" id=\"xo01\" onClick=\"delete_this(this.id)\"><br class=\"o01\">", $_SESSION['occupation_attempts'][1][0]);

          echo sprintf("<p class=\"form-text o01\">organization</p><input type=\"text\" class=\"o01\" name=\"organization01\" placeholder=\"Amazon\" value=\"%s\"><img class=\"empty-x o01\"><br class=\"o01\">", $_SESSION['occupation_attempts'][1][1]);

          echo sprintf("<p class=\"form-text o01\">start</p><input type=\"text\" class=\"o01\" name=\"startdate01\" placeholder=\"06/15/2015\" value=\"%s\"><img class=\"empty-x o01\"><br class=\"o01\">", $_SESSION['occupation_attempts'][1][2]);

          echo sprintf("<p class=\"form-text o01\">end</p><input type=\"text\" class=\"o01\" name=\"enddate01\" placeholder=\"09/15/2015\" value=\"%s\"><img class=\"empty-x o01\"><br class=\"o01\">", $_SESSION['occupation_attempts'][1][3]);

          echo sprintf("<p class=\"form-text o01\">projects</p><textarea class=\"o01\" name=\"projects01\" placeholder=\"CAPTCHA Machine Learning\" value=\"%s\"></textarea><img class=\"empty-x o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\"><br class=\"o01\">", $_SESSION['occupation_attempts'][1][4]);

          // occupation02
          echo sprintf("<p class=\"form-text o02\">position</p><input type=\"text\" class=\"o02\" name=\"position02\" placeholder=\"Data Scientist\" value=\"%s\"><img class=\"x o02\" id=\"xo02\" onClick=\"delete_this(this.id)\"><br class=\"o02\">", $_SESSION['occupation_attempts'][2][0]);

          echo sprintf("<p class=\"form-text o02\">organization</p><input type=\"text\" class=\"o02\" name=\"organization02\" placeholder=\"Amazon\" value=\"%s\"><img class=\"empty-x o02\"><br class=\"o02\">", $_SESSION['occupation_attempts'][2][1]);

          echo sprintf("<p class=\"form-text o02\">start</p><input type=\"text\" class=\"o02\" name=\"startdate02\" placeholder=\"07/20/2016\" value=\"%s\"><img class=\"empty-x o02\"><br class=\"o02\">", $_SESSION['occupation_attempts'][2][2]);

          echo sprintf("<p class=\"form-text o02\">end</p><input type=\"text\" class=\"o02\" name=\"enddate02\" placeholder=\"now\" value=\"%s\"><img class=\"empty-x o02\"><br class=\"o02\">", $_SESSION['occupation_attempts'][2][3]);

          echo sprintf("<p class=\"form-text o02\">projects</p><textarea class=\"o02\" name=\"projects02\" placeholder=\"AWS Lambda, AWS Cognito\" value=\"%s\"></textarea><img class=\"empty-x o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\"><br class=\"o02\">", $_SESSION['occupation_attempts'][2][4]);

          // create form elements for each of the occupations the user has input
          for($i = 3; $i < count($_SESSION['occupation_attempts']); $i++) {
            echo sprintf("<p class=\"form-text o%d%d\">position</p><input type=\"text\" class=\"o%d%d\" name=\"position%d%d\" value=\"%s\"><img class=\"x o%d%d\" id=\"xo%d%d\" onClick=\"delete_this(this.id)\"><br class=\"o%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['occupation_attempts'][i][0], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);

            echo sprintf("<p class=\"form-text o%d%d\">organization</p><input type=\"text\" class=\"o%d%d\" name=\"organization%d%d\" value=\"%s\"><img class=\"empty-x o%d%d\"><br class=\"o%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['occupation_attempts'][i][1], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);

            echo sprintf("<p class=\"form-text o%d%d\">start</p><input type=\"text\" class=\"o%d%d\" name=\"startdate%d%d\" value=\"%s\"><img class=\"empty-x o%d%d\"><br class=\"o%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['occupation_attempts'][i][2], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);

            echo sprintf("<p class=\"form-text o%d%d\">end</p><input type=\"text\" class=\"o%d%d\" name=\"enddate%d%d\" value=\"%s\"><img class=\"empty-x o%d%d\"><br class=\"o%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['occupation_attempts'][i][3], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);

            echo sprintf("<p class=\"form-text o%d%d\">projects</p><textarea class=\"o%d%d\" name=\"projects%d%d\" value=\"%s\"></textarea><img class=\"empty-x o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\"><br class=\"o%d%d\">", intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, $_SESSION['occupation_attempts'][i][4], intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10, intdiv($i, 10), $i%10);
          }

          // create form elements for the extra occupations (100 total occupations are created as a buffer)
          for($i = count($_SESSION['occupation_attempts']); $i < 100; $i++) {
          ...
          // the user has not input any occupations
          $occupations = getOccupations();

          // occupation00
          echo sprintf("<p class=\"form-text\">position</p><input type=\"text\" name=\"position00\" placeholder=\"B.A. Major in Math, Minor in Spanish\" value=\"%s\"><img class=\"empty-x\"><br>", $occupations[0][0]);
          ...
          echo sprintf("<p class=\"form-text\">end</p><input type=\"text\" name=\"enddate00\" placeholder=\"mm/dd/yyyy (\"now\" if it's a current occupation)\" value=\"%s\"><img class=\"empty-x\"><br>", $occupations[0][3]);
          ...
          // occupation01
          echo sprintf("<p class=\"form-text o01\">position</p><input type=\"text\" class=\"o01\" name=\"position01\" placeholder=\"Software Engineering Intern\" value=\"%s\"><img class=\"x o01\" id=\"xo01\" onClick=\"delete_this(this.id)\"><br class=\"o01\">", $occupations[1][0]);
          ...
          // occupation02
          echo sprintf("<p class=\"form-text o02\">position</p><input type=\"text\" class=\"o02\" name=\"position02\" placeholder=\"Data Scientist\" value=\"%s\"><img class=\"x o02\" id=\"xo02\" onClick=\"delete_this(this.id)\"><br class=\"o02\">", $occupations[2][0]);
          ...
          echo sprintf("<p class=\"form-text o02\">end</p><input type=\"text\" class=\"o02\" name=\"enddate02\" placeholder=\"now\" value=\"%s\"><img class=\"empty-x o02\"><br class=\"o02\">", $occupations[2][3]);
