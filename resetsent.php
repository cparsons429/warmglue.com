<?php
  ...
  if ($_SESSION['reset_confirmed'] != 1) {
    header("location: landing");
    exit();
  } else {
    // preventing information leakage
    $_SESSION['reset_confirmed'] = 0;
  }
 ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>warmglue: password reset sent</title>
  <meta charset="utf-8">
  <meta name="description" content="Your password reset has been sent.">
...
<body>
  ...
  <div class="main-body">
    <div class="basic-info">
      ...
      <?php
        echo sprintf("<p class=\"big-text\">Check your inbox at %s</p>", $_SESSION['email_attempt']);
       ?>
    </div>
  </div>
