<?php
  ...
  if (count($_SESSION['e_queue']) > 0) {
    ...
    if ($_SESSION['e_queue'][0][2] == "gmail") {
      verifyGmail($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else if ($_SESSION['e_queue'][0][2] == "yahoo") {
      verifyYahoo($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else if ($_SESSION['e_queue'][0][2] == "outlook") {
      verifyOutlook($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else if ($_SESSION['e_queue'][0][2] == "aol") {
      verifyAol($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else if ($_SESSION['e_queue'][0][2] == "icloud") {
      verifyIcloud($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else if ($_SESSION['e_queue'][0][2] == "comcast") {
      verifyComcast($mysqli, $_SESSION['e_queue'][0], $_SESSION['e_queue'][1]);
      exit();
    } else {
